      ...
      <div class="modal-body">
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_whymew_content__6">
                  If you are scared but want to use MEW, [get a hardware wallet](https://gochainwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.
                </li>
              </ul>
            </div>
          </section>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_secure_1_content__3">
                  Always check the URL: `https://www.gochainwallet.com`.
                </li>
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==9">
          ...
          <h5 class="text-center" translate="ONBOARD_secure_3_content__6">
            [Even more Security Tips!](https://gochainwallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)
          </h5>
          <div class="onboarding__buttons">
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==10">
          ...
          <section class="row row--flex">
            ...
            <div class="col-xs-12 col-sm-7">
              <ul>
                <li>
                  <a href="https://gochainwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html"
                     target="_blank" rel="noopener noreferrer" class="strong" translate="ONBOARD_final_content__2">
                      Get a hardware wallet
                  </a>
                </li>
                <li>
                  <a href="https://gochainwallet.github.io/knowledge-base/migration/moving-from-private-key-to-metamask.html"
                     target="_blank" rel="noopener noreferrer" class="strong" translate="ONBOARD_final_content__3">
                    How to Set up MEW + MetaMask
                  </a>
                </li>
                <li>
                  <a href="https://gochainwallet.github.io/knowledge-base/offline/running-myetherwallet-locally.html"
                     target="_blank" rel="noopener noreferrer" class="strong" translate="ONBOARD_final_content__4">
                    How to Run MEW Offline / Locally
                  </a>
                </li>
                <li>
                  <a href="https://gochainwallet.github.io/knowledge-base/migration/moving-from-private-key-to-ledger-hardware-wallet.html"
                ...
                <li>
                  <a href="https://gochainwallet.github.io/knowledge-base/hardware-wallets/trezor-sending-to-trezor-device.html"
                ...
                <li>
                  <a href="https://gochainwallet.github.io/knowledge-base/"
