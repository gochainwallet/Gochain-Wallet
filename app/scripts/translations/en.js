...
ENS_Finalize_content            :  'Finalizing this name assigns the ENS name to the winning bidder. The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 GOC. Any non-winners will also be refunded.',
...
ENS_Helper_16                   :  'The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 GOC.',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you GOC or tokens. 👍',
...
tx_FoundOnChain_3               :  '**If you do not see any errors, your transaction was successfully sent.** Your GOC or Tokens are where you sent them. If you cannot see this GOC or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please contact that service. Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different GOC node and check again.',
...
TXFEE_Desc                      :  'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> GOC here](https://www.gochainwallet.com/helpers.html)',

VIEWWALLET_HidePrivKey          :  '(hide)',
VIEWWALLET_ShowPrivKey          :  '(show)',
VIEWWALLET_Subtitle             :  'This allows you to download different versions of private keys and re-print your paper wallet. You may want to do this in order to import your account into Geth/Mist. If you want to check your balance, we recommend using a blockchain explorer like [explorer.gochain.io](https://testnet-explorer.gochain.io/).',
...
x_Access                        :  'Access',
x_AddessDesc                    :  'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you GOC or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
...
x_JsonDesc                      :  'This is the unencrypted, JSON format of your private key. This means you do not need the password but anyone who finds your JSON can access your wallet & GOC without the password.',
...
HELP_0_Desc_1                   :  'GoChainWallet gives you the ability to generate new wallets so you can store your GOC yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_0_Desc_5                   :  'Transfer GOC to this new wallet.',
