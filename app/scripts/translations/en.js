...
ENS_Finalize_content            :  'Finalizing this name assigns the ENS name to the winning bidder. The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 GO. Any non-winners will also be refunded.',
...
ENS_Helper_16                   :  'The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 GO.',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you GO or tokens. 👍',
...
ONBOARD_blockchain_content__5   :  'When you see your balance on GoChainWallet.com, you are seeing data on the blockchain, not in our personal systems.',
...
/* Old */
ADD_DigitalBitbox_0a            :  'Re-open GoChainWallet on a secure (SSL) connection',
ADD_DigitalBitbox_0b            :  'Re-open GoChainWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
ADD_DigitalBitbox_scan          :  'Connect your Digital Bitbox',
ADD_Secalot_0a              : 'Re-open GoChainWallet on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open GoChainWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_Ledger_0a                   :  'Please use GoChainWallet on a secure (SSL / HTTPS) connection to connect.',
ADD_Ledger_0b                   :  'Re-open GoChainWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
ERROR_35                        :  '(error_36) Input address is not checksummed. <a href="https://gochainwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>',
...
GETH_GasLimit                   :  '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://gochainwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
...
FOOTER_1                        :  'Free, open-source, client-side interface for generating Gochain wallets &amp; more. Interact with the Gochain blockchain easily &amp; securely. Double-check the URL ( gochainwallet.com ) before unlocking your wallet.',
...
GEN_Help_12                     :  'Use it to unlock your wallet via GoChainWallet (or Mist, Geth, Parity and other wallet clients.)',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your GoChainWallet CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via GoChainWallet.com. You can [download the GoChainWallet repo & run it locally](https://github.com/gochainwallet/etherwallet to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
sidebar_donation                :  'GoChainWallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
...
TRANS_gas                       :  'Gas Limit',
TRANS_sendInfo                  :  'A standard transaction using 21000 gas will cost 0.000441 GO. We do not take a transaction fee.',
...
tx_FoundOnChain_3               :  '**If you do not see any errors, your transaction was successfully sent.** Your GO or Tokens are where you sent them. If you cannot see this GO or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please contact that service. Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different GO node and check again.',
tx_Summary                      :  'During times of high volume (like during ICOs) transactions can be pending for hours, if not days. This tool aims to give you the ability to find and "cancel" / replace these TXs. ** This is not typically something you can do. It should not be relied upon & will only work when the TX Pools are full.',

TXFEE_Desc                      :  'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> GO here](https://www.gochainwallet.com/helpers.html)',

VIEWWALLET_HidePrivKey          :  '(hide)',
VIEWWALLET_ShowPrivKey          :  '(show)',
VIEWWALLET_Subtitle             :  'This allows you to download different versions of private keys and re-print your paper wallet. You may want to do this in order to import your account into Geth/Mist. If you want to check your balance, we recommend using a blockchain explorer like [explorer.gochain.io](https://explorer.gochain.io/).',
...
x_Access                        :  'Access',
x_AddessDesc                    :  'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you GO or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
...
x_JsonDesc                      :  'This is the unencrypted, JSON format of your private key. This means you do not need the password but anyone who finds your JSON can access your wallet & GO without the password.',
...
HELP_0_Desc_1                   :  'GoChainWallet gives you the ability to generate new wallets so you can store your GO yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_0_Desc_5                   :  'Transfer GO to this new wallet.',
...
HELP_12_Desc_20                 :  'This will prompt you to make a new password. This is the password you will use in geth / GoChain Wallet / Mist whenever you send a transaction, so don\'t forget it.',
HELP_12_Desc_21                 :  'After successful import, delete `nothing_special_delete_me.txt`',
HELP_12_Desc_22                 :  'The next time you open the GoChain Wallet application, your account will be listed under "Accounts".',
