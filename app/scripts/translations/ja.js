...
X_HelpfulLinks_4                :  'GoChainWalletから、またはGoChainWalletへ移行するには', /*Migrating to/from GoChainWallet*/
...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ GoChainWallet.com へようこそ！', /*Welcome to GoChainWallet.com*/
...
ONBOARD_bank_title              :  'GoChainWalletは金融機関に非ず', /*GoChainWallet is not a Bank*/
...
ONBOARD_interface_title         :  'GoChainWalletは窓口である', /*GoChainWallet is an Interface*/
ONBOARD_interface_content__1    :  'GoChainWalletを使って口座を開設すると、一組の暗号数列、すなわち秘密鍵と公開鍵（アドレス）が作成されます。', /*When you create an account on GoChainWallet you are generating a cryptographic set of numbers: your private key and your public key (address).*/
...
ONBOARD_whymew_title            :  'GoChainWalletができないなら、つまりどういうこと？', /*If GoChainWallet can\'t do those things, what\'s the point?*/
...
ONBOARD_whymew_content__6       :  'もし、少し不安だけれどもMEWを使いたければ、[ハードウェアウォレットを入手しましょう](https://gochainwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)！(英語) あなたの鍵を安全に保管してくれます。', /*If you are scared but want to use MEW, [get a hardware wallet](https://gochainwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.*/
...
ONBOARD_secure_1_content__1     :  'フィッシング詐欺師は、GoChainWalletやEtherDelta、Paypalやあなたの銀行に似せて作られたウェブサイトのリンクが含まれたメッセージを送りつけてきますが、これは偽サイトです。あなたの情報を盗み、そして資産を盗みます。', /*Phishers send you a message with a link to a website that looks just like GoChainWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.*/
  ONBOARD_secure_1_content__2     :  '[EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn)または[MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn)、[Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige)、[GoChainWallet Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm)を使って、悪質なサイトを遮断してください。', /*Install [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) or [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) or  or the [GoChainWallet Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) to block malicious websites.*/
ONBOARD_secure_1_content__3     :  'いつも、必ず、URLが「https://www.gochainwallet.com」であるを確認してください。', /*Always check the URL: `https://www.gochainwallet.com`.*/
ONBOARD_secure_1_content__4     :  'URLバーに、 `GOCHAINWALLET INC`と緑色で表示されていることを必ず確認してください。', /**/
...
ONBOARD_secure_3_content__6     :  '[さらなる安全確保のためのセキュリティ情報はこちら！](https://gochainwallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)', /*[Even more Security Tips!](https://gochainwallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)*/
...
/* Old */
ADD_DigitalBitbox_0a        : 'セキュア通信（SSL)で、GoChainWalletを開きなおしてください。',
ADD_DigitalBitbox_0b        : '[Chrome](https://www.google.com/chrome/browser/desktop/)か[Opera](https://www.opera.com/)で、GoChainWalletを開きなおしてください',
ADD_DigitalBitbox_scan      : 'Digital Bitboxに接続する',
ADD_Secalot_0a              : 'セキュア通信（SSL)で、GoChainWalletを開きなおしてください。',
ADD_Secalot_0b              : '[Chrome](https://www.google.com/chrome/browser/desktop/)か[Opera](https://www.opera.com/)で、GoChainWalletを開きなおしてください',
...
ADD_Ledger_0a               : 'セキュア通信（SSL)で、GoChainWalletを開きなおしてください。',
ADD_Ledger_0b               : '[Chrome](https://www.google.com/chrome/browser/desktop/)か[Opera](https://www.opera.com/)で、GoChainWalletを開きなおしてください',
...
ERROR_16                    : '(error_17) 同じアドレスのお財布が既に存在します。お財布のページをご確認ください。',
  ERROR_17                    : '(error_18) 残高が足りません。ガスリミット × ガス価格 + 送出したい量 が現在の残高より多いです。口座にETHを追加するか「残高をすべて送出する」ボタンを使ってください。もしこのエラーが間違いだと思う場合は、 トランザクションを生成しなおしてください。 必要量: (d+), 所持量: (d+) [詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
...
ERROR_35                    : '(error_36) 入力したアドレスには、チェックサムが付いていません。<a href="https://gochainwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">詳細はこちら</a>',
...
GETH_Balance                : '(geth-01) 残高が足りません。ガスリミット × ガス価格 + 送出したい量 が現在の残高より多いです。口座にETHを追加するか「残高をすべて送出する」ボタンを使ってください。もしこのエラーが間違いだと思う場合は、 トランザクションを生成しなおしてください。 必要量: (d+), 所持量: (d+) [詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
GETH_Cheap                  : '(geth-02) ガス価格が低すぎて承認できません。画面右上のドロップダウンメニューから、ガス価格を21 GWEIに上げてみてください。',
GETH_GasLimit               : '(geth-03) ブロックのガスリミットを超過しました。トランザクション・コストが現在のガスリミットを超過しました。 リミット: (d+), 指定: (d+). ガスリミットを21000（送出時）か200000（トークンや契約の送出時）より少なくして、もう一度お試しください。[詳細はこちら](https://gochainwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)',
GETH_InsufficientFunds      : '(geth-04) 残高が足りません。ガスリミット × ガス価格 + 送出したい量 が現在の残高より多いです。口座にETHを追加するか「残高をすべて送出する」ボタンを使ってください。もしこのエラーが間違いだと思う場合は、 トランザクションを生成しなおしてください。 必要量: (d+), 所持量: (d+) [詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
...
GETH_Nonce                  : '(geth-08) トランザクションの[nonce](https://gochainwallet.github.io/knowledge-base/transactions/what-is-nonce.html)が低すぎます。トランザクション生成ボタンを押してnonceを増やすか、[待機中トランザクションを置き換えてください](https://gochainwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)。',
GETH_NonExistentAccount     : '(geth-09) アカウントが存在しないか、残高不足です。',

PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションが既にインポートされています。このトランザクションは既に送出されている可能性があります。トランザクションの重複を防ぐために、[etherscan.io](https://etherscan.io)でアドレスを確認してください。再送出しようとする前に10分間待機してください。[詳しくはこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_GasLimitExceeded     : "(parity-02) トランザクション・コストが現在のガスリミットを超過しました。 リミット: (d+), 指定: (d+). ガスリミットを21000（送出時）か200000（トークンや契約の送出時）より少なくして、もう一度お試しください。[詳細はこちら](https://gochainwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)",　　　/* increasing gas limit???  Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://gochainwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)*/
PARITY_InsufficientBalance  : "(parity-03) 残高が足りません。トランザクションを送出しようとしているアカウントに、十分な量の資金がありません。もしこのエラーが間違いだと思う場合は、「残高をすべて送出する」ボタンを使うか、トランザクションを生成しなおしてください。必要量: (d+), 所持量: (d+) [詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_InsufficientGasPrice : "(parity-04) 同じnonceのトランザクションが既にキューに存在しているか、トランザクション手数料が低すぎます。トランザクション生成ボタンを押してnonceを増やしてください。[詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_InvalidGasLimit      : "(parity-05) ガス供給量が制限を超過しています。ガスリミットを21000に下げてください。[詳細はこちら](https://gochainwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)",
PARITY_LimitReached         : "(parity-06) キューに存在するトランザクションの数が多すぎます。上限超過のため、このトランザクションは除外されています。ガス価格を上げてください。[詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
PARITY_Old                  : "(parity-07) 同じ[nonce](https://gochainwallet.github.io/knowledge-base/transactions/what-is-nonce.html)のトランザクションが既に存在しています。トランザクション生成ボタンを押してnonceを増やすか、[待機中トランザクションを置き換えてください](https://gochainwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)。",
PARITY_TooCheapToReplace    : "(parity-08) トランザクション手数料が低すぎます。ご利用のノードの最低額を満たしていません（最低額: (d+), 指定: (d+)）。ガス価格かガスリミットを上げてください。[詳細はこちら](https://gochainwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",


  FOOTER_1                    : 'Ethereumウォレットを作成するための、無料で、オープンソースの、クライアントサイド・インターフェイス。Ethereumのブロックチェーンを簡単且つ安全に操作。お財布解錠の前に、URL( gochainwallet.com )を再確認してください。',
FOOTER_1b                   : '制作者:',
...
GEN_Help_12                 : 'GoChainWallet上でこれを使用し、お財布を解錠してください（Mist、Geth、Parityやその他のお財布クライアントでも可）。', /*Use it to unlock your wallet via GoChainWallet (or Mist, Geth, Parity and other wallet clients.)*/
...
MYWAL_Content_3             : '今後GoChainWallet CXでこのお財布を使用するためには、秘密鍵/JSONとパスワードを手動で追加する必要があります。',
...
NODE_Warning                : 'GoChainWallet.com 経由で接続するためには、HTTPSノードが必要です。[GoChainWalletをレポジトリからダウンロードして、ローカル環境で実行させて](https://github.com/gochainwallet/etherwallet、いずれかのノードに接続することもできます。または、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください。',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
sidebar_donation            : 'GoChainWalletは、無料で、オープンソースのサービスで、皆さまのプライバシーとセキュリティのための全力を尽くしています。寄付が増えることによって、新機能の作成やフィードバックの反映に多くの時間を費やし、よりユーザーの皆さまのご希望に沿ったものを提供することが可能になります。私たちは、たった二人で世界を変えようとしています。どうかお手伝いいただけませんか？',
sidebar_donate              : '寄付する',
...
tx_FoundOnChain_3           : '**何もエラーメッセージが表示されていなければ、トランザクションは正しく送出されました。** ETH/トークンは、送出先に到着しました。もし、ETH/トークンが他のお財布や取引所のウォレットに見つからず、送出から24時間以上経っていたら、[送出先のサービスに連絡](https://gochainwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html)してください。自分のトランザクションのリンクを連絡し、正確に状況を確認してもらってください。',
...
tx_notFound_4               : '画面右上のドロップダウンメニューから、別のノード（例: `ETH (Etherscan.io)`・`ETH (Infura.io)`・`ETH (GoChainWallet)`）を選択し、もう一度確認してください',
tx_Summary                  : '繁盛期（ICO実施中など）は、トランザクションは数時間（数日間ではなく）待機中のままになることがあります。このツールは、こういったトランザクションを検索し、「取り消し」または置き換えを行えるようにするためのものです。**これは通常は不要な操作です。このツールに頼るのは本来好ましいことではなく、TXプールが満杯のときのみ効果を発揮します。[このツールに関しては、こちらを参照してください。](https://gochainwallet.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',

TXFEE_Desc                  : 'トランザクション手数料は、トランザクションをブロックへ組み込むためにマイナーに支払われます。`ガスリミット` × `ガス価格`で算出されます。 [GWEI -> ETHの単位変換はこちらからどうぞ](https://www.gochainwallet.com/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://www.gochainwallet.com/helpers.html)*/
...
HELP_0_Desc_1               : 'GoChainWallet gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_3_Desc_3               : 'Navigate to the GoChainWallet.com "View Wallet Info" page.',
...
HELP_4CX_Title              : '4) How do I send Ether using GoChainWallet CX?',
...
HELP_5_Title                : '5) How do I run GoChainWallet.com offline/locally?',
HELP_5_Desc_1               : 'You can run GoChainWallet.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7               : 'GoChainWallet.com is now running entirely on your computer.',
HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the GoChainWallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact.',
HELP_5_Desc_9               : 'As we are constantly updating GoChainWallet.com, we recommend you periodically update your saved version of the repo.',
...
HELP_8_Desc_1               : 'GoChainWallet is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain.',
HELP_8_Desc_2               : 'If GoChainWallet.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of GoChainWallet because it\'s not in GoChainWallet. It\'s in whatever wallet your generated via our site.',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with GoChainWallet CX. That way if anything happens to GoChainWallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets.',
HELP_8CX_Desc_3             : 'If for some reason GoChainWallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
...
HELP_12_Title               : '12) How do I import a wallet created with GoChainWallet into geth / Ethereum Wallet / Mist?',
HELP_12_Desc_1              : 'Using an Geth/Mist JSON file from GoChainWallet v2+....',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. GoChainWallet.com doesn\'t do this. Is the random number generation for GoChainWallet safe?',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, GoChainWallet.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
...
HELP_SecCX_Title            : 'Security - GoChainWallet CX',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use GoChainWallet.com instead of this Chrome Extension.',
