...
NODE_Warning                : 'GoChainWallet.com 経由で接続するためには、HTTPSノードが必要です。[GoChainWalletをレポジトリからダウンロードして、ローカル環境で実行させて](https://github.com/kvhnuke/etherwallet/releases/latest)、いずれかのノードに接続することもできます。または、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください。',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
